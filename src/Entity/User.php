 ...
 * )
 * @UniqueEntity("email", message="Un utilisateur ayant cette email existe deja")
 */
class User implements UserInterface
{
     ...
     * @Assert\Length(
     *  min=3,
     *  minMessage="Le prénom doit plus de 3 caractères", 
     *  max=255,
     ...
     * @Assert\Length(
     *  min=3,
     *  minMessage="Le nom doit plus de 3 caractères", 
     *  max=255,
