...
class Invoice
{
     ...
     * @Groups({"invoices_read", "customers_read", "invoices_subresource"})
     * @Assert\NotBlank(message="La statut est obligatoire")
     * @Assert\Choice(
     *  choices={"SENT", "PAID", "CANCELLED"},
     *  message="Le statut doit etre paid/sent/cancelled"
     * )
     */
    private $status;
     ...
     * @Assert\NotBlank(message="La client de la facture est obligatoire")
     */
    private $customer;
     ...
     * @Assert\Type("integer", message="chrono doit etre un int")
     */
    private $chrono;
